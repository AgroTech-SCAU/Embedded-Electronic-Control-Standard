...
| 模块 | 目录 | 说明 |
|---|---|---|
| motor | `motor/` | 电机统一接口、入口单例、PortOps、达妙电机实例 |
...
├── rgb_led/        # 计划：SPI/PWM DMA 写入 PortOps 与灯珠缓存
...
- `motor/README.md`：当前电机 SDK 说明
- `examples/module_design/portops_motor_device/`：从需求到 service 绑定的 PortOps 贯穿式示例
