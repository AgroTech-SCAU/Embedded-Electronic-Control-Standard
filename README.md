...
```bash
# 根据需求选择 <tag-name>，例如 v1.0.0
git submodule add -b <tag-name> https://github.com/Kaede-Rei/Embedded-Electronic-Control-Standard.git external/Embedded-Electronic-Control-Standard
...
git fetch origin
git switch <tag-name>                   # 例如 v1.0.0
git pull --ff-only origin <tag-name>    # 例如 v1.0.0
...
```bash
git submodule -b <tag-name> add https://github.com/Kaede-Rei/Embedded-Chip-STM32-HAL-SDK.git external/Embedded-Chip-STM32-HAL-SDK
