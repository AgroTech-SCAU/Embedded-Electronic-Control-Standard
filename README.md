...
git add .gitmodules external/chips/Embedded-Chip-STM32-HAL-SDK
...
```bash
git submodule add https://github.com/<user-or-org>/Embedded-Chip-Renesas-FSP-SDK.git external/chips/Embedded-Chip-Renesas-FSP-SDK
git add .gitmodules external/chips/Embedded-Chip-Renesas-FSP-SDK
